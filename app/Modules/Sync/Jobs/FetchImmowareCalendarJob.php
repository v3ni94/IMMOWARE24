...
/**
 * Dünner Wrapper um RunSyncJob für den Kalender (CalDAV).
 */
final class FetchImmowareCalendarJob extends RunSyncJob
{
    public function __construct(
        ...
        parent::__construct($connectionId, SyncEntity::CalendarEvent->value, $mode, $cursor, $runId, $lockOwner, $correlationId, $triggerSource, $limit, $singleRecord, $startedBy);
    }
