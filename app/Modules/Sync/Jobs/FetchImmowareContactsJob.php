...
/**
 * Dünner Wrapper um RunSyncJob für den Kontaktspiegel (CardDAV).
 */
final class FetchImmowareContactsJob extends RunSyncJob
{
    public function __construct(
        ...
        parent::__construct($connectionId, SyncEntity::Contact->value, $mode, $cursor, $runId, $lockOwner, $correlationId, $triggerSource, $limit, $singleRecord, $startedBy);
    }
