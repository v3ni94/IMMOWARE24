...
final class SyncStartRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'mode' => ['required', 'string', Rule::in(['incremental', 'full'])],
    ...
    {
        return ['connection_id' => 'Connection', 'entity_type' => 'Entität', 'mode' => 'Modus'];
    }
}
